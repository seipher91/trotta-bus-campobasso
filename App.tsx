      ...
      <header className="sticky top-0 z-30 glass-panel border-b border-white/20 shadow-sm px-4 pt-safe-top pb-2">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="text-center">
            <h2 className="font-bold text-slate-800 text-lg leading-none">{currentLineData.name}</h2>
            <span className="text-[10px] text-slate-500 font-medium uppercase tracking-wide">
              {currentLineData.description}
            </span>
          </div>
        ...
        <div className="mt-2 mb-2 space-y-3">
          ...
          <div className="relative max-w-[240px] mx-auto">
            ...
            >
              {currentLineData.schedules[0].times.map((time, idx) => (
